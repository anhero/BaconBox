 ...
 */
#ifndef BB_DEFAULT_SERIALIZER_H
...
namespace BaconBox {
	...
	public:
		 ...
		 * that will take care of the serialization, see BaconBox::Vector2T for
		 * an example.
		 ...
		 * cannot be derived from Serializable, you can write static functions
		 * that will take care of the serialization, see BaconBox::Vector2T for an
		 * example.
