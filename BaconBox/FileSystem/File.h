...
namespace BaconBox {
	...
	public:
		 ...
		 */
		virtual unsigned char* toBuffer(unsigned int offset = 0, unsigned int length = 0) = 0;
		/**
		 ...
		 */
		virtual int fillBuffer(void* buffer, unsigned int offset = 0, unsigned int length = 0) = 0;
		/**
		 ...
		 * @return
		 */
		virtual int seek(unsigned int offset = 0) = 0;
		/**
		 ...
		 */
		virtual std::string read(unsigned int to_read = 0) = 0;
		/**
