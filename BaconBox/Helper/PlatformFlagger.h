...
//Linux systems
	...
	#define BB_TIME_HELPER_INCLUDE "LibcTimeHelper.h"
...
//Windows systems
	...
	#define BB_TIME_HELPER_INCLUDE "WindowsTimeHelper.h"
#endif // _WIN32
...
//Apple systems
	...
	//More detailed platforms
		...
		#define BB_TIME_HELPER_INCLUDE "IOSTimeHelper.h"
...
//SDL platform
	...
	#define BB_SOUND_ENGINE_INCLUDE "SDLMixerEngine.h"

	#define BB_MUSIC_ENGINE_IMPL SDLMixerEngine::getInstance()
	#define BB_MUSIC_ENGINE_INCLUDE "SDLMixerEngine.h"

	//Input engine for SDL
	#define BB_KEYBOARD_IMPL new SDLKeyboard()
	#define BB_KEYBOARD_INCLUDE "SDLKeyboard.h"

	#define BB_POINTER_IMPL new SDLPointer()
	#define BB_POINTER_INCLUDE "SDLPointer.h"

    #define BB_GAME_PAD_IMPL new SDLGamePad(i)
    #define BB_GAME_PAD_INCLUDE "SDLGamePad.h"

	#define BB_INPUT_MANAGER_IMPL BaconBox::SDLInputManager
	#define BB_INPUT_MANAGER_INCLUDE "SDLInputManager.h"

	#define BB_MAIN_WINDOW_IMPL new SDLMainWindow()
	#define BB_MAIN_WINDOW_INCLUDE "SDLMainWindow.h"
...
//iOS platform
	...
	#define BB_OPENAL
	#define BB_SOUND_ENGINE_IMPL new OpenALEngine()
	#define BB_SOUND_ENGINE_INCLUDE "OpenALEngine.h"
