...
namespace BaconBox {
	...
	public:
		...
		MovieClipEntity *getMovieClipEntityFromSubTexture(SubTextureInfo* subTex, const VMATH_NAMESPACE::Vector2f & origin = VMATH_NAMESPACE::Vector2f(), bool blend = true, float scale = 1.0f);
#endif
