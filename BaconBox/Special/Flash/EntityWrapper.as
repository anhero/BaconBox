...
public class MovieClipEntity {
	public var swigCPtr:int;
	public static function create(aMC:*):MovieClipEntity {
		var obj = new MovieClipEntity();
		obj.swigCPtr = _wrap_new_MovieClipEntity(aMC);
		return obj;
	}

	public function setMovieClip(aMC:*):void {
		_wrap_MovieClipEntity_setMovieClip(swigCPtr, aMC);
	}

	public function destroy():void {
		_wrap_delete_MovieClipEntity(swigCPtr);
	}
