...
${OBJECTDIR}/_ext/31560488/PlayState.o: ../../../Main/PlayState.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/31560488/PlayState.o ../../../Main/PlayState.cpp

${OBJECTDIR}/_ext/31560488/main.o: ../../../Main/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/31560488
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/31560488/main.o ../../../Main/main.cpp
